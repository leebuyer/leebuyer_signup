...
<form action="index.php" method="post" id="myForm" enctype="multipart/form-data" class="form-horizontal">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" name="title" id="title" class="form-control validate[required]" value="<{$title}>" placeholder="請輸入標題活動標題">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <textarea name="detail" id="detail" class="form-control validate[required]" placeholder="請輸入標題活動內容"><{$detail}></textarea>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" name="end_date" id="end_date" class="form-control validate[required]" value="<{$end_date}>" placeholder="請輸入報名截止日期"  onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss' , startDate:'%y-%M-%d %H:%m:%s}'})">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" name="action_date" id="action_date" class="form-control validate[required]" value="<{$action_date}>" placeholder="請輸入活動日期" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss' , startDate:'%y-%M-%d %H:%m:%s}'})">
        </div>
    </div>
