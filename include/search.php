...
function leebuyer_signup_search($queryarray, $andor, $limit, $offset, $userid)
{
    global $xoopsDB;
    ...
    $sql = "SELECT `id`,`title`,`action_date`, `uid` FROM " . $xoopsDB->prefix("leebuyer_signup_actions") . " WHERE 1";
    if ($userid != 0) {
        $sql .= " AND uid=" . $userid . " ";
    }
